...
![GitHub Repository](./_images/repo.png)
...
![Add New Project](./_images/add-new.png)

![Import from GitHub](./_images/import.png)
...
![Buying a Domain](./_images/buy-domain.png)
...
![Add Domain to Vercel](./_images/add-domain.png)
...
![Configure Domain](./_images/config-domain.png)

![Set Nameservers](./_images/config-nameservers.png)
